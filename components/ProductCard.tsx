      ...
      <motion.div initial={{y:'100%'}} animate={{y:0}} exit={{y:'100%'}} transition={{type:'spring',damping:28,stiffness:300}}
        ...
        <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:8,padding:'0 20px' }}>
          <button onClick={onAdd}
            style={{ height:52,borderRadius:14,border:'none',cursor:'pointer',background:'linear-gradient(135deg,#9A7840,#D4AF77)',color:'#1C1610',fontSize:13,fontWeight:800,display:'flex',alignItems:'center',justifyContent:'center',gap:8,boxShadow:'0 4px 20px rgba(154,120,64,.3)' }}>
            <span style={{fontSize:18}}>🛒</span> Panier
          </button>
          <button onClick={onSimulate}
            style={{ height:52,borderRadius:14,border:'1.5px solid rgba(154,120,64,.35)',background:'rgba(212,175,119,.08)',cursor:'pointer',color:'#6B5030',fontSize:12,fontWeight:800,display:'flex',alignItems:'center',justifyContent:'center',gap:6 }}>
        ...
        <div style={{ padding: compact ? '12px 12px 14px' : '14px 14px 16px' }}>
          ...
          <div style={{ display:'flex',gap:6,marginTop: compact ? 8 : 0 }}>
            <motion.button whileTap={{scale:.93}} onClick={handleAdd}
              style={{ flex:1,height:48,borderRadius:12,border:`1.5px solid ${added?'rgba(40,180,100,.4)':'rgba(154,120,64,.3)'}`,cursor:'pointer',fontFamily:'Raleway,sans-serif',
            ...
            <motion.button whileTap={{scale:.93}} onClick={handleSimulate}
              title="Simuler en 3D"
              style={{ width:48,height:48,borderRadius:12,border:'1.5px solid rgba(154,120,64,.22)',background:'rgba(212,175,119,.06)',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',fontSize:16,flexShrink:0 }}>
              📐
            </motion.button>
            <motion.button whileTap={{scale:.93}}
              onClick={e => { e.stopPropagation(); window.open(whatsappProduct(product),'_blank') }}
              title="Commander sur WhatsApp"
              style={{ width:48,height:48,borderRadius:12,border:'1.5px solid rgba(37,211,102,.3)',background:'rgba(37,211,102,.06)',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0 }}>
